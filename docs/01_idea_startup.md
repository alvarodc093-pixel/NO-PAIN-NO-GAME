...
- **¿Por qué es importante?** Adquirir un jugador nuevo cuesta $3-8 (CPI medio móvil). Si 2 de cada 3 se van en 7 días, el CAC se pierde. Retener un solo jugador genera $15-50 de LTV (lifetime value).
