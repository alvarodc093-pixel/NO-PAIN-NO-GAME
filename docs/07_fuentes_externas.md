...
1. **GameAnalytics** — "Mobile Gaming Benchmarks 2026": D1 22% / D7 4% / D30 0,7%.
   Prueba que el problema de retención existe más allá de Steam.
2. **Sensor Tower** — "Mobile Gaming Market Report": conversión a pago F2P 2–5%.
   Nuestro proxy high_value (19,9%) es deliberadamente más amplio (documentado).
3. **AppsFlyer** — CPI medio puzzle $3–8 (inputs de la calculadora ROI).
4. **AppMagic** — ARPDAU $0.12 F2P (inputs de la calculadora ROI).
...
- Títulos PC/F2P como análogos del F2P móvil: misma economía (gratis + in-game),
  distinta plataforma — el piloto con tus eventos cierra el gap.
